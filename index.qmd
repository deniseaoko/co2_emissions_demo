...
```{python}
pip install itables country_converter
```
```{python}
import pandas as pd
import numpy as np
...
selected_countries = ["Afghanistan", "Austria", "Brazil", "China", "Italy"]
...
fig_chart = px.line(emissions_long_subset,x="year",y="emissions",color="country",title="Emissions Over Time by Country")
fig_chart
```
